...
import { listingMyBids, listingPackage } from '../services/home.service';
    ...
    return (
        <div>
            ...
            <div className={`container py-2 px-3 `}>
                <h4 className='text-center mx-auto mt-3'>My Bids</h4>
                        ...
                        packageData?.length > 0 ? (
                            packageData?.map((v, i) => (
                                <div className="card m-2" style={{width: '18rem'}}>
                                    <img className='card-img-top' src={v.image} alt="Card cap" style={{height:'170px'}}/>
                                        ...
                                        {/* <label className='status accept'>{v.my_total_bid}</label> */}
                            ...
                            (
                                <div className='w-100 d-flex align-items-center justify-content-center'>
                                    <h3 className='h3 text-secondary'>bid not found!</h3>
                                </div>
                            )
